...
if ( $('#login-form').length > 0 ) {
    $(document).on('submit', '#login-form', function(e) {
        e.preventDefault();
        var status = $('#company option:selected').val();
        var form = $(this);
        if(status == 1){
            $.ajax({
            type     : "POST",
            ...
            async    : true,
            cache    : false,
            url      : baseurl + "company_one/?case=LoginProcessHandler",
            data     : form.serialize(),
...
$(document).ready(function() {
    ...
    if ( $('#attendance').length > 0 ) {
        ...
        var att_table = $('#attendance').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": baseurl + "company_one/?case=LoadingAttendance",
            "order": [0, 'desc'],
            "columnDefs": [{
                "targets": 0,
                "className": "dt-center"
    ...
    if ( $('#admin-salary').length > 0 ) {
        ...
        var admin_sal_table = $('#admin-salary').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": baseurl + "company_one/?case=LoadingSalaries",
            "order": [0, 'desc'],
            "columnDefs": [{
                "targets": 0,
                "className": "dt-center"
    ...
    if ( $('#employees').length > 0 ) {
        ...
        var emp_table = $('#employees').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": baseurl + "company_one/?case=LoadingEmployees",
            "columnDefs": [{
                "targets": 0,
                "className": "dt-center"
            }, {
        ...
        $('#employees tbody').on('click', '.addSalary', function(e) {
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=GetAllPayheadsExceptEmployeeHave",
             ...
             var status = $('#company').val();
                if(status == 1){
                    $.ajax({
                        ...
                        async    : true,
                        cache    : false,
                        url      : baseurl + "company_one/?case=GetEmployeePayheadsByID",
                        data     : 'emp_code=' + data[0],
                        success  : function(result) {
        ...
        $('#employees tbody').on('click', '.deleteEmp', function(e) {
            ...
            if ( conf ) {
                ...
                $.ajax({
                    ...
                    async    : true,
                    cache    : false,
                    url      : baseurl + "company_one/?case=DeleteEmployeeByID",
                    data     : 'emp_code=' + data[0],
                    success  : function(result) {
                        if ( result.code == 0 ) {
                            $.notify({
    ...
    if ( $('#holidays_ts').length > 0 ) {
        /* Holiday Table Script Start */
        var holi_table = $('#holidays_ts').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": baseurl + "company_one/?case=LoadingHolidays",
            "columnDefs": [{
                "targets": 0,
                "className": "dt-center"
            }, {
        ...
        /* Edit Holiday Script Start */
        $('#holidays_ts tbody').on('click', '.editHoliday', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=GetHolidayByID",
                data     : 'id=' + data[0],
                success  : function(result) {
                    if ( result.code == 0 ) {
                        $("#holiday_id").val(result.result.holiday_id);
    ...
    if ( $('#assign-payhead-form').length > 0 ) {
        $('#assign-payhead-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=AssignPayheadsToEmployee",
                data     : form.serialize(),
                success  : function(result) {
                    if ( result.code == 0 ) {
                        $.notify({
        ...
        $('#holiday-form').on('submit', function(e) {
           ...
           var status = $('#company').val();
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=InsertUpdateHolidays",
                data     : form.serialize(),
                success  : function(result) {
                    if ( result.code == 0 ) {
                        $.notify({
    ...
    if ( $('#edit-emp-form').length > 0 ) {
        $('#edit-emp-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=EditEmployeeDetailsByID",
                data     : form.serialize(),
                success  : function(result) {
                    if ( result.code == 0 ) {
                        $.notify({
    ...
    if(status == 1){
        var pay_table = $('#payheads').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": baseurl + "company_one/?case=LoadingPayheads",
            "columnDefs": [{
                "targets": 0,
                "className": "dt-center"
            }, {
                ...
                "data": null,
                "className": "dt-center",
                "defaultContent": '<button class="btn btn-success btn-xs editPayheads"><i class="fa fa-edit"></i></button> <button class="btn btn-danger btn-xs deletePayheads_ts"><i class="fa fa-trash"></i></button>'
            }]
        });
    }else{
        var pay_table = $('#payheads').DataTable({
        ...
        $('#payheads tbody').on('click', '.deletePayheads_ts', function(e) {
            e.preventDefault();
            ...
            if ( conf ) {
                ...
                $.ajax({
                    ...
                    async    : true,
                    cache    : false,
                    url      : baseurl + "company_one/?case=DeletePayheadByID",
                    data     : 'id=' + data[0],
                    success  : function(result) {
                        if ( result.code == 0 ) {
                            $.notify({
    ...
    if ( $('#payhead-form').length > 0 ) {
       ...
       if ( $('#payhead-form-ts').length > 0 ) {
        $('#payhead-form-ts').on('submit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=InsertUpdatePayheads",
                data     : form.serialize(),
                success  : function(result) {
                    if ( result.code == 0 ) {
                        $.notify({
    ...
    if ( $('#payslip-form').length > 0 ) {
        $('#payslip-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=GeneratePaySlip",
                data     : form.serialize(),
                success  : function(result) {
                    if ( result.code == 0 ) {
    ...
    if ( $('#allleaves').length > 0 ) {
      ...
      if ( $('#allleaves_ts').length > 0 ) {
        var leave_table = $('#allleaves_ts').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": baseurl + "company_one/?case=LoadingAllLeaves",
            "columnDefs": [{
                "targets": 0,
                "className": "dt-center"
            }, {
        ...
        /* Approve Leave Application Script Start */
        $('#allleaves_ts tbody').on('click', '.approveLeave', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=ApproveLeaveApplication",
                data     : 'id=' + data[0],
                success  : function(result) {
                    if ( result.code == 0 ) {
                        $.notify({
        ...
        $('#allleaves tbody').on('click', '.rejectLeave', function(e) {
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=RejectLeaveApplication",
                data     : 'id=' + data[0],
                success  : function(result) {
                    if ( result.code == 0 ) {
                        $.notify({
    ...
    if ( $('#leave-form').length > 0 ) {
     ...
     if ( $('#leave-form-ts').length > 0 ) {
        $('#leave-form-ts').on('submit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                async    : true,
                cache    : false,
                url      : baseurl + "company_one/?case=ApplyLeaveToAdminApproval",
                data     : form.serialize(),
                success  : function(result) {
                    if ( result.code == 0 ) {
                        form[0].reset();
