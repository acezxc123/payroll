<?php
 require_once(dirname(__FILE__) . '/hris_at_config.php');
	...
	$sql = "SELECT * from wy_salaries WHERE `cut-off-from-to` BETWEEN '".$datestart."' AND '" .$dateend. "' and payhead_name='HMDF Contribution'  ORDER BY generate_date desc";
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">HMDF Report</li>
				</ol>
			</section>
        			...
        			<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">HMDF Report</h3>
