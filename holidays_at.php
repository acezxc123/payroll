					            	...
					            	<div class="col-sm-6">
							            <div class="form-group">
											<label for="compulsory_holiday">
												<input type="radio" value="nonworking" id="working" name="holiday_type" class="minimal" checked /> Non Working Holiday
											</label>
										</div>
									</div>
									<div class="col-sm-6">
							            <div class="form-group">
											<label for="restricted_holiday">
												<input type="radio" value="working" id="working" name="holiday_type" class="minimal" /> Working Holiday
											</label>
										</div>
									</div>
					            </div>
