...
define('REG_URL', 	   'http://localhost/payroll/registration_at/');
...
if ( isset($_SESSION['Admin_ID']) && isset($_SESSION['Login_Type']) && isset($_SESSION['company']) )
  $userData = GetDataByIDAndType($_SESSION['Admin_ID'], $_SESSION['Login_Type'], $_SESSION['company']);
else
  $userData = array();
