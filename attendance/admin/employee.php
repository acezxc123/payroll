                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="https://chart.googleapis.com/chart?chs=500x500&cht=qr&chl=<?php echo $row['employee_id']; ?>&choe=UTF-8" target="_blank">
                              <img src="https://chart.googleapis.com/chart?chs=500x500&cht=qr&chl=<?php echo $row['employee_id']; ?>&choe=UTF-8" width="35px" height="35px" alt=""></td>
                            </a>
