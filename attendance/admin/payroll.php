        ...
        <div class="row">
          <div class="col-xs-12">
                ...
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      $count_emp = mysqli_query($conn, "SELECT * FROM attendance WHERE employee_id = '$empid' AND date BETWEEN '$from' AND '$to'");
                      $count_row = mysqli_num_rows($count_emp);
            ...
            <div class="box">
              <div class="box-header with-border">
                <div class="pull-right">
                  <h1 style="margin: 0;padding: 10px;"><?php echo 'Total: '. '&#8369;'.number_format($total, 2);?></h1>
                </div>
              </div>
            </div>
