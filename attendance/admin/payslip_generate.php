	...
	$contents .= '
			...
			<table cellspacing="0" cellpadding="3">  
				...
				<tr> 
    	    		<td></td> 
    	    		<td></td>
				 	<td width="25%" align="right">No. of Hectare:</td>
				 	<td width="25%" align="right">' . number_format($hectare_no, 0) . '</td> 
    	    	</tr>
				<tr> 
    	    		<td></td> 
    	    		<td></td>
				 	<td width="25%" align="right"><b>Total Hectare Salary</b></td>
				 	<td width="25%" align="right"><b> PHP ' . number_format($hectare_salary_display, 2) . '</b></td> 
    	    	</tr>
    	    	<tr> 
    	    		<td></td> 
    	    		<td></td>
    	    	...
    	    	<tr> 
    	    		...
    	    		<td></td>
				 	...
				 	<td width="25%" align="right"><b> PHP ' . number_format($net, 2) . '</b></td> 
    	    	</tr>
