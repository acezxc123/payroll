    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box w3-flat-wet-asphalt">
            <div class="inner ">
              <?php
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box w3-flat-green-sea">
            <div class="inner">
              <?php
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box w3-flat-peter-river">
            <div class="inner">
              <?php
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box w3-flat-pomegranate">
            <div class="inner">
              <?php
              ...
              <div class="box-tools pull-right">
                <form class="form-inline">
                  <div class="form-group">
                    ...
                    <select class="form-control input-sm" id="select_year"  style="border-radius: 5px;">
                      <?php
                        for($i=2015; $i<=2065; $i++){
...
$(function(){
  ...
  barChartData.datasets[1].fillColor   = '#0073CF'
  barChartData.datasets[1].strokeColor = '#0073CF'
  barChartData.datasets[1].pointColor  = '#0073CF'
  var barChartOptions                  = {
